...
```powershell
corepack pnpm --filter @eregister/wit-grid-core exec vitest run src/rowModel.capabilities.test.ts src/serverRowModel.test.ts src/engine/architectureGuards.test.ts
