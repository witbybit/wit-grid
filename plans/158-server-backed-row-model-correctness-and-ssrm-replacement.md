...
- Plan files use the handoff template in `C:\Users\rishi\witbybit\wit-grid\.agents\skills\improve\references\plan-template.md`.
- Existing row-model demolition evidence already lives in:
    - `C:\Users\rishi\witbybit\wit-grid\docs\architecture\plan-158-readiness-audit.md`
    - `C:\Users\rishi\witbybit\wit-grid\docs\architecture\plan-158-server-page-deletion-manifest.md`
...
| Core focused tests              | `corepack pnpm --filter @eregister/wit-grid-core exec vitest run src/serverRowModel.test.ts src/serverRowModel.adversarial.test.ts src/renderer/renderEngine.test.ts src/renderer/serverRuntimePerformance.test.ts`                                                                                                                                                                                                        | all pass                         |
| Core full tests                 | `corepack pnpm --filter @eregister/wit-grid-core test`                                                                                                                                                                                                                                                                                                                                                                     | exit 0; all tests pass           |
...
| Architecture guards             | `corepack pnpm --filter @eregister/wit-grid-core exec vitest run src/boundary.test.ts src/engine/architectureGuards.test.ts`                                                                                                                                                                                                                                                                                               | all pass                         |
...
- Before each commit, run at least `corepack pnpm --filter @eregister/wit-grid-core test` and ensure it is green.
...
**Verify**: `corepack pnpm --filter @eregister/wit-grid-core exec vitest run src/serverRowModel.test.ts src/serverRowModel.adversarial.test.ts src/renderer/renderEngine.test.ts` -> all pass
...
**Verify**: `corepack pnpm --filter @eregister/wit-grid-core exec vitest run src/serverRowModel.test.ts src/serverRowModel.adversarial.test.ts src/renderer/serverRuntimePerformance.test.ts` -> all pass
...
**Verify**: `corepack pnpm --filter @eregister/wit-grid-core test` -> exit 0; all tests pass
...
**Verify**: `corepack pnpm --filter @eregister/wit-grid-core exec vitest run src/serverRowModel.test.ts src/serverRowModel.adversarial.test.ts src/rowModel.capabilities.test.ts src/query/queryModel.test.ts src/store.test.ts` -> all pass
...
- Verification:
    - `corepack pnpm --filter @eregister/wit-grid-core test` -> all pass
    - `corepack pnpm --filter @eregister/wit-grid-react test` -> all pass
